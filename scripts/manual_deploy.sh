...
docker build -f ./Dockerfile.01 -t gcr.io/pwc-bat-test/hedera-integration-node-01:${BUILD_VERSION} .
docker push "gcr.io/pwc-bat-test/hedera-integration-node-01:${BUILD_VERSION}"

docker build -f ./Dockerfile.02 -t gcr.io/pwc-bat-test/hedera-integration-node-02:${BUILD_VERSION} .
docker push "gcr.io/pwc-bat-test/hedera-integration-node-02:${BUILD_VERSION}"
